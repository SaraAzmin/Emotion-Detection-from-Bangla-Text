...
for line_gold, line_system in zip(file_gold, file_system):
    ...
    if len(line_gold) != 0:
        ...
        precision_recall[tag_system][1] += 1 # predict_tag was assigned by system
        precision_recall[tag_gold][2] += 1 # predict_tag was found in gold standard data

        # observe and count correct tags
        if tag_system == tag_gold:
            precision_recall[tag_gold][0] += 1 # predict_tag assignment was correct
